...
<div class="container-fluid banner product product_category_page_banner" style="padding:0px;position:relative;">
	<img src="<?php echo base_url();?>homepage_assests/banner/summitflooring-about-02.jpg" class="cust_container4" alt="educational_category_application_area"style="width:100%;height:auto;">
	<div class="container">
		<div class="row">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="corridore1 cust_corridore">
				<div class="corridore_img"><img src="<?php echo base_url();?>homepage_assests/banner/summitflooring-sport-mat.png" alt="summitflooring-sport-mat"></div>
		...
		<div class="col-md-4">
			<div class="corridore2 cust_corridore">
				<div class="corridore_img"><img src="<?php echo base_url();?>homepage_assests/banner/summitflooring-next-step-luxery.png" alt="summitflooring-next-step-luxery"></div>
				<h4 class="page_title"><span>Area Size</span></h4>
				<ul class="common_class">
					<li>6mm</li>
					<li>8mm</li>
		...
		<div class="col-md-4">
			<div class="corridore3 cust_corridore">
				<div class="corridore_img1"><img src="<?php echo base_url();?>homepage_assests/banner/summitflooring-evolution.png" alt="summitflooring-evolution"></div>
				<h4 class="page_title"><span>Area Size</span></h4>
				<ul class="common_class">
					<li>6mm</li>
					<li>8mm</li>
